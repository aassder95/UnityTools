...
namespace UnityTools.Samples.Util
{
    public static class SampleTestUiBuilder
    {
        ...
        private const float BOTTOM_TAB_SAFE_MARGIN = 128f;
        ...
        public readonly struct Layout
        {
            ...
            //Constructors
            //============================================================
            public Layout(RectTransform rtRoot, RectTransform rtControls, RectTransform rtContentViewport)
            {
                RtRoot = rtRoot;
        ...
        public static Layout Build(Transform parent, string title, string subtitle)
        {
            ...
            Stretch(rtHeader, new Vector2(0f, 1f), new Vector2(1f, 1f), new Vector2(24f, -188f), new Vector2(-24f, -20f));
            ...
            Stretch(rtTitle, new Vector2(0f, 1f), new Vector2(1f, 1f), new Vector2(24f, -84f), new Vector2(-24f, -16f));

            GameObject goSubtitle = CreateText(rtHeader, "TxtSubtitle", subtitle, 22, FontStyle.Normal, new Color(0.78f, 0.86f, 0.97f, 1f));
            RectTransform rtSubtitle = goSubtitle.GetComponent<RectTransform>();
            Stretch(rtSubtitle, new Vector2(0f, 1f), new Vector2(1f, 1f), new Vector2(24f, -148f), new Vector2(-24f, -94f));

            RectTransform rtControls = CreateRect("GoControls", rtRoot);
            Stretch(rtControls, new Vector2(0f, 1f), new Vector2(1f, 1f), new Vector2(24f, -360f), new Vector2(-24f, -200f));
            ...
            Stretch(rtControlsWrap, Vector2.zero, Vector2.one, new Vector2(8f, 8f), new Vector2(-8f, -8f));
            ...
            controlsLayout.spacing = new Vector2(10f, 8f);
            controlsLayout.cellSize = new Vector2(150f, 58f);
            ...
            controlsLayout.constraintCount = 4;

            RectTransform rtCard = CreateRect("GoContentCard", rtRoot);
            Stretch(rtCard, new Vector2(0f, 0f), new Vector2(1f, 1f), new Vector2(24f, BOTTOM_TAB_SAFE_MARGIN), new Vector2(-24f, -372f));
            ...
            Stretch(rtContentViewport, new Vector2(0f, 0f), new Vector2(1f, 1f), new Vector2(18f, 18f), new Vector2(-18f, -18f));

            return new Layout(rtRoot, rtControlsWrap, rtContentViewport);
        }
        ...
        public static void ReparentToContent(RectTransform rtTarget, RectTransform rtContentViewport, Vector2 offsetMin, Vector2 offsetMax)
        {
            ...
            Stretch(rtTarget, new Vector2(0f, 0f), new Vector2(1f, 1f), offsetMin, offsetMax);
        ...
        public static Button CreateActionButton(Transform parent, string buttonName, string labelText, UnityAction onClick)
        {
            ...
            rtButton.sizeDelta = new Vector2(150f, 58f);

            Image buttonImage = rtButton.gameObject.AddComponent<Image>();
            buttonImage.color = new Color(0.13f, 0.36f, 0.72f, 1f);
            Outline buttonOutline = rtButton.gameObject.AddComponent<Outline>();
            buttonOutline.effectColor = new Color(0f, 0f, 0f, 0.28f);
            buttonOutline.effectDistance = new Vector2(0f, -2f);
